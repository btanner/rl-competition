...
public class JarExperimentRunner extends AbstractExperimentRunner{
    ...
    public void runMDP(MDPDetails theMDP) {
        ...
        String theEnvJarTitle = theEnvJarName.substring(0, theEnvJarName.length() - 4);
        ...
        loadEnvironment(theEnvJarTitle);
...
//       theController.getView().episodeProgressBar.setMaximum(totalStepsAllowed);
    ...
    public static void main(String[] args){
        try {
            JarExperimentRunner J = new JarExperimentRunner(RLEvent.MountainCar, null);
            J.setup();
