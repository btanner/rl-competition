...
public class TetrisMultiTrainer extends AbstractMultiTrainer {

	public static void main(String[] args) throws InterruptedException {
		AbstractMultiTrainer theTrainer=new TetrisMultiTrainer();
	...
	protected void runAllMDPs(){
				...
				for(int i=0;i<super.numMDP;i++){
					...
					consoleTrainerHelper.loadTetris(thisMDPNumber);
					totalReturn+=runCurrentMDP(tetrisStepLimit);
				}	
