...
/*
 * This file contains a class used to describe the domain's current 
 * parameter settings. 
 *
 */ 
...
public class Parameters
{
  ...
  int base_radius, base_sight_range, base_hp, base_armor, base_cost, 
      base_build_time, base_atk_range, base_atk_value;
  
  int marine_radius, marine_sight_range, marine_hp, marine_armor, marine_max_speed, 
      marine_cost, marine_training_time, marine_atk_value, marine_atk_range;
  ...
  int worker_radius, worker_sight_range, worker_hp, worker_armor, worker_max_speed,
      ...
      worker_atk_range, worker_atk_value;
  ...
  public void parseTaskSpec(String spec)
  {
    ...
    for (String s : keyvalPairs) {
      ...
      else if  (key.equals("base_atk_range"))                  base_atk_range = Integer.parseInt(val);               
      ...
      else if  (key.equals("base_atk_value"))                  base_atk_value = Integer.parseInt(val);               
      ...
      else if  (key.equals("marine_atk_range"))                marine_atk_range = Integer.parseInt(val);               
      ...
      else if  (key.equals("marine_atk_value"))                marine_atk_value = Integer.parseInt(val);               
      ...
      else if  (key.equals("worker_atk_range"))                worker_atk_range = Integer.parseInt(val);               
      ...
      else if  (key.equals("worker_atk_value"))                worker_atk_value = Integer.parseInt(val);               
