...
Controller theController=null;
    ...
    private void initComponents() {
        ...
        mountainCarRadio = new javax.swing.JRadioButton();
        RTSRadio = new javax.swing.JRadioButton();
        tetrisRadio = new javax.swing.JRadioButton();
        polyRadio = new javax.swing.JRadioButton();
        keepawayRadio = new javax.swing.JRadioButton();
        jPanel3 = new javax.swing.JPanel();
        testingMountainCarRadio = new javax.swing.JRadioButton();
        testingHelicopterRadio = new javax.swing.JRadioButton();
        testingRTSRadio = new javax.swing.JRadioButton();
        testingTetrisRadio = new javax.swing.JRadioButton();
        testingPolyRadio = new javax.swing.JRadioButton();
        testingKeepawayRadio = new javax.swing.JRadioButton();
        ...
        eventSelectButtonGroup.add(mountainCarRadio);
        mountainCarRadio.setText(resourceMap.getString("mountainCarRadio.text")); // NOI18N
        mountainCarRadio.setEnabled(false);
        mountainCarRadio.setName("mountainCarRadio"); // NOI18N
        mountainCarRadio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mountainCarRadioActionPerformed(evt);
            }
        });

        eventSelectButtonGroup.add(RTSRadio);
        RTSRadio.setText(resourceMap.getString("RTSRadio.text")); // NOI18N
        RTSRadio.setEnabled(false);
        RTSRadio.setName("RTSRadio"); // NOI18N
        RTSRadio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                RTSRadioActionPerformed(evt);
            }
        });
        ...
        eventSelectButtonGroup.add(keepawayRadio);
        keepawayRadio.setText(resourceMap.getString("keepawayRadio.text")); // NOI18N
        keepawayRadio.setEnabled(false);
        keepawayRadio.setName("keepawayRadio"); // NOI18N
        keepawayRadio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                keepawayRadioActionPerformed(evt);
            }
        });
        ...
        eventSelectPanelLayout.setHorizontalGroup(
            ...
            .add(mountainCarRadio, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE)
            .add(helicopterRadio, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE)
            .add(RTSRadio, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE)
            ...
            .add(keepawayRadio, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE)
        );
        eventSelectPanelLayout.setVerticalGroup(
            eventSelectPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(eventSelectPanelLayout.createSequentialGroup()
                .add(mountainCarRadio)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(helicopterRadio)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                .add(RTSRadio)
        ...
        eventSelectButtonGroup.add(testingMountainCarRadio);
        testingMountainCarRadio.setText(resourceMap.getString("testingMountainCarRadio.text")); // NOI18N
        testingMountainCarRadio.setEnabled(false);
        testingMountainCarRadio.setName("testingMountainCarRadio"); // NOI18N
        testingMountainCarRadio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                testingMountainCarRadioActionPerformed(evt);
            }
        });
        ...
        eventSelectButtonGroup.add(testingRTSRadio);
        testingRTSRadio.setText(resourceMap.getString("testingRTSRadio.text")); // NOI18N
        testingRTSRadio.setEnabled(false);
        testingRTSRadio.setName("testingRTSRadio"); // NOI18N
        testingRTSRadio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                testingRTSRadioActionPerformed(evt);
            }
        });
        ...
        eventSelectButtonGroup.add(testingKeepawayRadio);
        testingKeepawayRadio.setText(resourceMap.getString("testingKeepawayRadio.text")); // NOI18N
        testingKeepawayRadio.setEnabled(false);
        testingKeepawayRadio.setName("testingKeepawayRadio"); // NOI18N
        testingKeepawayRadio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                testingKeepawayRadioActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .add(testingMountainCarRadio, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE)
            .add(testingHelicopterRadio, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE)
            .add(testingRTSRadio, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE)
            ...
            .add(testingKeepawayRadio, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 434, Short.MAX_VALUE)
        );
        jPanel3Layout.setVerticalGroup(
            jPanel3Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
            .add(jPanel3Layout.createSequentialGroup()
                .add(testingMountainCarRadio)
                .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
            ...
            .add(progressPanelLayout.createSequentialGroup()
                ...
                .add(progressPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(org.jdesktop.layout.GroupLayout.TRAILING, progressPanelLayout.createSequentialGroup()
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(mdpProgressBar, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE))
                    .add(episodeProgressBar, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE)
                    .add(jLabel2, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE)
                    .add(jLabel5, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 437, Short.MAX_VALUE))
                .add(progressPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                    .add(progressPanelLayout.createSequentialGroup()
                        .addPreferredGap(org.jdesktop.layout.LayoutStyle.RELATED)
                        .add(progressPanelLayout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING)
                            .add(org.jdesktop.layout.GroupLayout.TRAILING, TimeElapsed, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)
                            .add(jLabel7, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)
                            .add(jLabel6, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 389, Short.MAX_VALUE)))
                    .add(progressPanelLayout.createSequentialGroup()
                        .add(9, 9, 9)
                        .add(TimeRemaining, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, 390, Short.MAX_VALUE)))
                .addContainerGap())
        );
    ...
    private void mountainCarRadioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mountainCarRadioActionPerformed
        theController.eventSelected(RLEvent.MountainCar);
    }//GEN-LAST:event_mountainCarRadioActionPerformed
    ...
    private void RTSRadioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RTSRadioActionPerformed
        theController.eventSelected(RLEvent.RTS);
        // TODO add your handling code here:
    }//GEN-LAST:event_RTSRadioActionPerformed
...
private void keepawayRadioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_keepawayRadioActionPerformed
     theController.eventSelected(RLEvent.Keepaway);
    // TODO add your handling code here:
}//GEN-LAST:event_keepawayRadioActionPerformed

private void testingMountainCarRadioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_testingMountainCarRadioActionPerformed
    // TODO add your handling code here:
    theController.eventSelected(RLEvent.Testing_MountainCar);
}//GEN-LAST:event_testingMountainCarRadioActionPerformed
...
private void testingRTSRadioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_testingRTSRadioActionPerformed
    theController.eventSelected(RLEvent.Testing_RTS);
    // TODO add your handling code here:
}//GEN-LAST:event_testingRTSRadioActionPerformed
...
private void testingKeepawayRadioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_testingKeepawayRadioActionPerformed
    theController.eventSelected(RLEvent.Testing_Keepaway);
    // TODO add your handling code here:
}//GEN-LAST:event_testingKeepawayRadioActionPerformed
    ...
    public javax.swing.JRadioButton RTSRadio;
    ...
    public javax.swing.JRadioButton keepawayRadio;
    private javax.swing.JPanel mainPanel;
    public javax.swing.JProgressBar mdpProgressBar;
    private javax.swing.JMenuBar menuBar;
    public javax.swing.JRadioButton mountainCarRadio;
    ...
    private javax.swing.JRadioButton testingKeepawayRadio;
    private javax.swing.JRadioButton testingMountainCarRadio;
    private javax.swing.JRadioButton testingPolyRadio;
    private javax.swing.JRadioButton testingRTSRadio;
    ...
    public void setDefaultButtonNames() {
        ...
        mountainCarRadio.setText("Mountain Car (runs remaining this week: ?)");
        RTSRadio.setText("Real Time Strategy (runs remaining this week: ?)");
        tetrisRadio.setText("Tetris (runs remaining this week: ?)");
        polyRadio.setText("Polyathalon (runs remaining this week: ?)");
        keepawayRadio.setText("Keepaway (runs remaining this week: ?)");
        testingHelicopterRadio.setText("Helicopter Hovering (runs remaining: ?)");
        testingMountainCarRadio.setText("Mountain Car (runs remaining: ?)");
        testingRTSRadio.setText("Real Time Strategy (runs remaining: ?)");
        testingTetrisRadio.setText("Tetris (runs remaining: ?)");
        testingPolyRadio.setText("Polyathalon (runs remaining: ?)");
        testingKeepawayRadio.setText("Keepaway (runs remaining: ?)");
    }
    ...
    public void setNumberRunsAvailable(RLEvent theEvent, int num){
        switch(theEvent){
            case Helicopter :
                ...
                break;
            case MountainCar :
                mountainCarRadio.setText("Mountain Car (runs remaining this week: " + num + ")");
                break;
            case Tetris :
                tetrisRadio.setText("Tetris (runs remaining this week: " + num + ")");
                break;
            case RTS :
                RTSRadio.setText("Real Time Strategy (runs remaining this week: " + +num + ")");
                break;
            case Polyathlon :
                polyRadio.setText("Polyathalon (runs remaining this week: " + num + ")");
                break;
            case Keepaway :
                keepawayRadio.setText("Keepaway (runs remaining this week: " + num + ")");
                break;
            case Testing_Helicopter :
                testingHelicopterRadio.setText("Helicopter Hovering (runs remaining: " + num + ")");
                break;
            case Testing_MountainCar :
                testingMountainCarRadio.setText("Mountain Car (runs remaining: " + num + ")");
                break;
            case Testing_Tetris :
                testingTetrisRadio.setText("Tetris (runs remaining: " + num + ")");
                break;
            case Testing_RTS :
                testingRTSRadio.setText("Real Time Strategy (runs remaining: " + +num + ")");
                break;
            case Testing_Polyathlon :
                testingPolyRadio.setText("Polyathalon (runs remaining: " + num + ")");
                break;
            case Testing_Keepaway :
                testingKeepawayRadio.setText("Keepaway (runs remaining: " + num + ")");
                break;
            default:
                System.exit(1);
                break;
    ...
    public void setVisibilities(boolean allowed[], boolean validAuthToken) {
        ...
        helicopterRadio.setEnabled(allowed[RLEvent.Helicopter.id()]);
        mountainCarRadio.setEnabled(allowed[RLEvent.MountainCar.id()]);
        tetrisRadio.setEnabled(allowed[RLEvent.Tetris.id()]);
        RTSRadio.setEnabled(allowed[RLEvent.RTS.id()]);
        polyRadio.setEnabled(allowed[RLEvent.Polyathlon.id()]);
        keepawayRadio.setEnabled(allowed[RLEvent.Keepaway.id()]);
        testingHelicopterRadio.setEnabled(allowed[RLEvent.Testing_Helicopter.id()]);
        testingMountainCarRadio.setEnabled(allowed[RLEvent.Testing_MountainCar.id()]);
        testingTetrisRadio.setEnabled(allowed[RLEvent.Testing_Tetris.id()]);
        testingRTSRadio.setEnabled(allowed[RLEvent.Testing_RTS.id()]);
        testingPolyRadio.setEnabled(allowed[RLEvent.Testing_Polyathlon.id()]);
        testingKeepawayRadio.setEnabled(allowed[RLEvent.Testing_Keepaway.id()]);
        ...
        somethingSelected |= mountainCarRadio.isSelected();
        somethingSelected |= tetrisRadio.isSelected();
        somethingSelected |= RTSRadio.isSelected();
        somethingSelected |= polyRadio.isSelected();
        somethingSelected |= keepawayRadio.isSelected();
        somethingSelected |= testingHelicopterRadio.isSelected();
        somethingSelected |= testingMountainCarRadio.isSelected();
        somethingSelected |= testingTetrisRadio.isSelected();
        somethingSelected |= testingRTSRadio.isSelected();
        somethingSelected |= testingPolyRadio.isSelected();
        somethingSelected |= testingKeepawayRadio.isSelected();
