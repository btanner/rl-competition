...
public class PhoneHomeStub implements PhoneHomeConnectionInterface{
    ...
    public MDPDetails getNextMDP(AuthToken theAuthToken, String theKey) throws invalidKeyException, notAuthenticatedException, noMDPsAvailableException {
            ...
            String fileName = "";
            if (eventNum == RLEvent.MountainCar.id()) {
            ...
            if (eventNum == RLEvent.RTS.id()) {
                fileName = "RTSPMDP" + MDPNumber + ".txt";
            }
            if (eventNum == RLEvent.Keepaway.id()) {
                fileName = "keepaway.txt";
            }
            if (eventNum == RLEvent.Testing_MountainCar.id()) {
                fileName = "MCPMDP" + MDPNumber + ".jar";
            }
            ...
            if (eventNum == RLEvent.Testing_RTS.id()) {
                fileName = "RTSPMDP" + MDPNumber + ".txt";
            }
            if (eventNum == RLEvent.Testing_Keepaway.id()) {
                fileName = "keepaway.txt";
            }
            String debugJarDir = "../../rlcomplibrary/system/proving/debugJars/";
        ...
        try {
            ...
            MDPDetails theMDP = new MDPDetails(fileName, RLEvent.eventFromNumber(eventNum),MDPNumber, theKey, stepsPerMDP);
